...
<div className='welcome'>
    <div className='welcome-container'>
        ...
        <section className='welcome-panel'>
            ...
            <p>
              <center><button ref='projectButton' onclick={this.didClickCreateProjectButton} className='btn btn-primary inline-block-tight icon icon-file-directory-create'>
                &nbsp;&nbsp;&nbsp;&nbsp;Create a React Native Project
              </button></center>
            </p>
            <p>
              <center><button ref='projectButton' onclick={this.didClickProjectButton} className='btn btn-primary inline-block-tight icon icon-file-directory'>
                &nbsp;&nbsp;&nbsp;&nbsp;Add Project Folder&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              </button></center>
            </p>
        </section>
