          ...
          <section className='welcome-panel'>
            ...
            <details className='welcome-card' {...this.getSectionProps('new')}>
              <summary className='welcome-summary icon icon-repo'>
                Start a <span className='welcome-highlight'>new</span> React Native project
              </summary>
              <div className='welcome-detail'>
                ...
                <p>
                  ...
                  <button ref='projectButton' onclick={this.didClickAppTemplateButton} className='btn btn-primary inline-block-tight'>
                    Create Project with App Template
                  </button>
                </p>
              </div>
            </details>
